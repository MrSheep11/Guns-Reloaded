...
execute store result score @e[type=minecraft:marker,tag=new_bullet,sort=nearest,limit=1] gunsr.fire run data get entity @e[type=minecraft:marker,tag=new_bullet,sort=nearest,limit=1] data.fire_power 1
